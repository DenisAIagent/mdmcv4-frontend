...
// Si AdminPanel gère la navigation interne, n'utilisez pas useNavigate ici pour les actions internes.
...
function SmartlinkListPage({ onNavigateToCreate, onNavigateToEdit }) {
  ...
  // const navigate = useNavigate(); // Supprimé car la navigation interne est gérée par AdminPanel
  ...
  // CORRECTION BUILD : L'annotation de type TypeScript ': GridColDef[]' a été enlevée.
  const columns = [
    {
