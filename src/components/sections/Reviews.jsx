...
const Reviews = () => {
  ...
  const openModal = () => { setModalIsOpen(true); setFormError(null); setFormSuccess(null); }; // Ouvrir modale
  const closeModal = () => { setModalIsOpen(false); }; // Fermer modale
...
// === ASSURE-TOI QUE CETTE LIGNE EST BIEN LÀ À LA FIN ===
