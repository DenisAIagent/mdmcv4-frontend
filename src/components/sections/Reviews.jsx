...
const Reviews = () => {
  ...
  const submitReview = async (e) => {
    ...
    // Méthode 1: Via variable d'environnement Vite (préférable)
    const apiUrl = import.meta.env.VITE_API_URL;
    // Méthode 2: URL en dur (moins bien, mais si VITE_API_URL n'est pas définie)
    // const apiUrl = 'https://mdmcv4-backend-production.up.railway.app/api';

    if (!apiUrl) {
        console.error("Erreur: L'URL de l'API n'est pas configurée (VITE_API_URL manquante ?)");
        setFormError(t('reviews.form.error_config')); // Erreur de configuration
        setIsSubmitting(false);
        return;
    }
    // --- Fin détermination URL ---

    try {
      const response = await fetch(`${apiUrl}/reviews`, { // Assure-toi que le chemin est juste /reviews (pas /api/reviews si apiUrl contient déjà /api)
        method: 'POST',
      ...
      setTimeout(() => { closeReviewForm(); }, 3000);
  ...
  return (
    <section id="reviews" className="reviews-section">
      <div className="container">
        ...
        {/* Affichage du carrousel - Vérifie cette partie si elle a disparu */}
              ...
              >
                <div className="review-header">
                  <div className="review-avatar">
                    {/* Assure-toi que le chemin vers les avatars est correct */}
      ...
      {/* Modal pour le formulaire d'avis - avec composants contrôlés */}
      {showReviewForm && (
            ...
            <form onSubmit={submitReview}>
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  // *** DEBUG CONSOLE LOG ***
                  onChange={(e) => {
                    console.log('Name onChange triggered:', e.target.value); // <<<=== LOG AJOUTÉ
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  required
                  value={email}
                  onChange={(e) => setEmail(e.target.value)} // Ajoute un log ici aussi si besoin
                  disabled={isSubmitting}
                />
              </div>
              <div className="form-group">
              ...
              <div className="form-group">
                ...
                <textarea
                  ...
                  required
                  value={message}
                  onChange={(e) => setMessage(e.target.value)} // Ajoute un log ici aussi si besoin
                  disabled={isSubmitting}
                ></textarea>
              </div>
